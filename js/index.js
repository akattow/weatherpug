...
function getWeather() {
	$.getJSON("https://ipinfo.io/", function(x) {
		...
		var apiUrl =
			"https://cors-anywhere.herokuapp.com/http://api.openweathermap.org/data/2.5/weather?lat=%lat%&lon=%long%&APPID=527a4c21b597169e7cec5fce156297ef";
		...
		$.getJSON(urlLatLong, function(y) {
			...
			tempFahrenheit = Math.round(
				Number((9 * (tempKelvin - 273.15) / 5 + 32).toFixed(2))
			);
